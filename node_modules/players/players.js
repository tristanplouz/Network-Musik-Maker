module.exports =function(){
    ...
    }; //Créer un nouvel user et gere les salons 
    ...
    this.connected =function(socket){
        ...
        socket.to(this.salonContent[this.co[this.co.length-1]]).emit('connected',this.salonContent[this.co[this.co.length]]);
        console.log('to:'+this.salonContent[this.co.length]+'connected');
